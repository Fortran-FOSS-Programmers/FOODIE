...
Tables \ref{tab:oscillation_errors_explicit} and \ref{tab:oscillation_errors_pred_corr} summarize the errors analysis.

\begin{table}[!ht]
  \centering
  \caption{Oscillation test: errors analysis of explicit solvers}\label{tab:oscillation_errors_explicit}
...
\begin{table}[!ht]
  \centering
  \caption{Oscillation test: errors analysis of predictor-corrector solvers}\label{tab:oscillation_errors_pred_corr}
  \begin{subtable}[b]{0.45\textwidth}
    \centering
...
\begin{figure}[!ht]
  ...
  \begin{subfigure}[b]{0.45\textwidth}
    ...
    \caption{1 step solution}\label{fig:results-oscillation-adams-bashforth-moulton-1}
  \end{subfigure}\quad%
  \begin{subfigure}[b]{0.45\textwidth}
    \centering
    ...
    \caption{2 steps solution}\label{fig:results-oscillation-adams-bashforth-moulton-2}
  \end{subfigure}\\
  \begin{subfigure}[b]{0.45\textwidth}
    \centering
    ...
    \caption{3 steps solution}\label{fig:results-oscillation-adams-bashforth-moulton-3}
  \end{subfigure}\quad%
  \begin{subfigure}[b]{0.45\textwidth}
    \centering
    ...
    \caption{4 steps solution}\label{fig:results-oscillation-adams-bashforth-moulton-4}
  \end{subfigure}
