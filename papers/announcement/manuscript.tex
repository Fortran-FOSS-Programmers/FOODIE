...
Currently FOODiE provides 5/6/7 stages, all $4^{th}$ order, 2N registers explicit schemes, the coefficients of which are listed in tables \ref{tab:RK-ls-5}, \ref{tab:RK-ls-6} and \ref{tab:RK-ls-7}.
...
\begin{table}[!ht]
  \centering
  \caption{Williamson's table of 6 stages, $4^{th}$ order, Runge-Kutta low storage scheme\label{tab:RK-ls-6}}
  \resizebox{0.40\textwidth}{!}{%
  \begin{tabular}{cccc}
    Stage & $A$               & $B$              & $C$              \\
    \hline
...
\begin{table}[!ht]
  ...
  \begin{subtable}[b]{0.45\textwidth}
    \centering
    \caption{Low storage Runge-Kutta 6 stages}\label{tab:oscillation-ls-rk-s}
    \resizebox{1.00\textwidth}{!}{%
    \begin{tabular}{ccccc}
      \toprule
      {\sc Time Step} & {\sc Error X} & {\sc Error Y} & {\sc Order X} & {\sc Order Y} \\
  ...
  \begin{subtable}[b]{0.45\textwidth}
    \centering
    \caption{Low storage Runge-Kutta 7 stages}\label{tab:oscillation-ls-rk-7}
    \resizebox{1.00\textwidth}{!}{%
    \begin{tabular}{ccccc}
      \toprule
      {\sc Time Step} & {\sc Error X} & {\sc Error Y} & {\sc Order X} & {\sc Order Y} \\
