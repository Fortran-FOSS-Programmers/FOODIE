...
\begin{table}[!ht]
  ...
  \begin{tabular}{cccccc}
    ...
    \multirow{6}{*}{Adams-Bashforth 4 steps}
                 &   5000.0        &  0.384E+09    &  0.380E+09    & /             & /             \\
                 &   2500.0        &  0.871E+01    &  0.869E+01    & 25.39         & 25.38         \\
                 &   1250.0        &  0.314E+01    &  0.312E+01    &  1.47         &  1.48         \\
                 &    625.0        &  0.111E+01    &  0.111E+01    &  1.49         &  1.49         \\
                 &    320.0        &  0.409E+00    &  0.407E+00    &  1.50         &  1.50         \\
                 &    100.0        &  0.714E-01    &  0.711E-01    &  1.50         &  1.50         \\
...
Note that in the summary.log file into error analysis directory I have computed also the product of $f*\Delta t$ in order to verify when the instability arises.

For AB-2 and AB-4 the solution with $\Delta t=5000 \rightarrow f*\Delta t=0.5$ results to be unstable (the computational modes are not dumped) while for AB-3 it is stable, but the (physical mode) amplitude is dumped resulting into large errors. This is consistent with Duran results, where AB-3 is said to be unstable for $ f*\Delta t>0.724$.

The AB-2 and AB-4 solutions show a phase error that decreases as the time resolution increases. The AB-3 has no phase error and the computational modes are dumped for all $\Delta t$ exercised.
}
