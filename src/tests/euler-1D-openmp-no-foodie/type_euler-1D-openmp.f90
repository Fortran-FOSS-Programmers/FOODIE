!< Define Euler 1D (OpenMP enabled) field.
...
contains
  ...
  ! type bound procedures of euler_1D_openmp
  ! auxiliary methods
  ...
  !---------------------------------------------------------------------------------------------------------------------------------
  class(euler_1D_openmp), intent(IN) :: self      !< Euler field.
  type(euler_1D_openmp)              :: dState_dt !< Euler field time derivative.
